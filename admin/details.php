            ...
            <div class="row gy-4"">
                ...
                <div class="card" style="width: 800px;">
                    <div class="d-flex justify-content-center mt-4 mb-2">
                        <img src=" galery/<?= $mtr['foto'] ?>" class="card-img-top" alt="..." style="width: 350px; height:250px;  border-radius: 20px;">
                    </div>
                    <div class="card-body">
                        ...
                        <a href="hapus.php?id=<?= $mtr['id_motor']; ?>" onclick="return confirm('yakin ingin mengapus data?');" class="btn btn-danger">HAPUS</a>
                    </div>
